<template>
  <div>
    <a-input-search v-model="searchStr" placeholder="输入搜选项"  @search="onSearch"></a-input-search>
    ...
    >
      ...
      <template #name="{ key: treeKey, name }">
...
<script>
import { treeData } from "../../mock/tree/treeData";
